...
//    OBJID_POS_MTR               = 0x2240,
    ...
    OBJID_VEL_ACT1              = 0x6069, //from velocity encoder
    OBJID_VEL_SENSOR_SELECT     = 0x606A, //0000h from position encoder,0001h from velocity encoder
    OBJID_VEL_DEMAND         		= 0x606B, //from trajectory generator
		OBJID_VEL_ACT2              = 0x606C, //used as input to the velocity controller
		OBJID_VEL_WINDOW            = 0x606D,
		OBJID_VEL_WINDOW_TIME       = 0x606E,
		OBJID_VEL_THRESHOLD         = 0x606F,
		OBJID_VEL_THRESHOLD_TIME    = 0x6070,
//    OBJID_VEL_LIM               = 0x2230,
//    OBJID_VEL_LOAD              = 0x2231,
   OBJID_VEL_TARGET            = 0x60FF,
