...
BCFG0               EQU   ( (0x00<<03):OR:(0x00<<06):OR:(0x01<<07):OR:(0x00<<8):OR:(0x00<<19):OR:(0x00<<20) )
BCFG1               EQU   ( (0x00<<03):OR:(0x00<<06):OR:(0x01<<07):OR:(0x00<<8):OR:(0x00<<19):OR:(0x00<<20) )
BCFG2               EQU   ( (0x00<<03):OR:(0x00<<06):OR:(0x01<<07):OR:(0x00<<8):OR:(0x00<<19):OR:(0x00<<20) )
BCFG3               EQU   ( (0x00<<03):OR:(0x00<<06):OR:(0x01<<07):OR:(0x00<<8):OR:(0x00<<19):OR:(0x00<<20) )

STATICCFG0	        EQU   ( BCFG_16DEF:OR:BCFG0 ) 
STATICCFG1          EQU	  ( BCFG_16DEF:OR:BCFG1 )
STATICCFG2	        EQU	  ( BCFG_16DEF:OR:BCFG2 )
STATICCFG3          EQU	  ( BCFG_16DEF:OR:BCFG3 )
